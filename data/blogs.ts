export const blogs = [
  {
    ...
    image: "/blog1.jpg",
    content: `
The world of AI agents is exploding with innovation, offering new ways to automate tasks, enhance customer experiences, and unlock smarter workflows across industries. At AgenticLib, we curate the best AI agents to help you discover exactly what fits your needs.
