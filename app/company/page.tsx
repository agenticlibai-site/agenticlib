  ...
  return (
    <main style={{ minHeight: "100vh", background: BG }}>
      <article style={{
        ...
        {/* Vision body */}
        <div style={{ fontSize: 17, lineHeight: 1.8, display: "flex", flexDirection: "column", gap: 22 }}>
          <p>
        ...
        <div style={{ fontSize: 17, lineHeight: 1.8, display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <div style={{ fontSize: 17, lineHeight: 1.8, marginTop: 22, display: "flex", flexDirection: "column", gap: 22 }}>
          <p>
