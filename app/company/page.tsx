    ...
    <main style={{ minHeight: "100vh" }}>
      ...
      <section style={{ maxWidth: 680, margin: "0 auto", padding: "64px 32px 96px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          ...
          <div>
            <p style={{ fontSize: 16, fontWeight: 600, color: "#000", marginBottom: 2 }}>Srinidhi Murali</p>
            <p style={{ fontSize: 12, fontWeight: 600, color: "#6c4cf1", textTransform: "uppercase", letterSpacing: "0.1em" }}>Founder</p>
          </div>
        </div>
      </section>
