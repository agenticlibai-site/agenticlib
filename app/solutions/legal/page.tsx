...
export const metadata: Metadata = {
  title: "Legal AI Agents – FeatureStream",
  description: "FeatureStream helps legal AI agents compete. Track LLM visibility among law firms and GCs, benchmark contract review and document intelligence against tools like Harvey, Ironclad and Clio, and surface how buyers evaluate legal AI before shortlisting.",
  ...
  openGraph: { type: "website", siteName: "FeatureStream", title: "Legal AI Agents – FeatureStream", description: "Track your legal AI agent's visibility among law firms and GCs, benchmark document intelligence against competitors, and surface where buyers are finding alternatives.", url: "https://agenticlib.com/solutions/legal", images: [{ url: "/recommendations-cover.png", width: 1200, height: 630, alt: "FeatureStream – Legal AI" }] },
  twitter: { card: "summary_large_image", title: "Legal AI Agents – FeatureStream", description: "Track your legal AI agent's visibility among law firms and GCs, benchmark document intelligence against competitors, and surface where buyers are finding alternatives.", images: ["/recommendations-cover.png"] },
};
    ...
    <main className="min-h-screen page-gap-fix" style={{ background: "linear-gradient(170deg, #ECFDF5 0%, #FDFAFF 28%, #FFF8FC 52%, #F8F3FF 76%, #ECFDF5 100%)" }}>
      ...
      <section style={{ position: "relative", overflow: "hidden", padding: "110px 48px 80px" }}>
        ...
        <div style={{ maxWidth: 760, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
          ...
          <p style={{ fontSize: 18, lineHeight: 1.7, color: "#444", maxWidth: 540, margin: "0 auto 40px" }}>FeatureStream tracks where your product appears when GCs and law firms evaluate legal AI — and benchmarks every feature that earns trust in a high-stakes buying decision.</p>
      ...
      <section style={{ maxWidth: 860, margin: "0 auto", padding: "72px 48px 96px" }}>
        <div style={{ background: "rgba(255,255,255,0.65)", backdropFilter: "blur(24px)", WebkitBackdropFilter: "blur(24px)", border: `1px solid rgba(${A},0.12)`, borderRadius: 20, padding: "44px 44px 48px", boxShadow: `0 4px 32px rgba(${A},0.07), 0 1px 4px rgba(0,0,0,0.04)` }}>
          ...
          <p style={{ fontSize: 15, color: "#555", lineHeight: 1.65, maxWidth: 560, marginBottom: 36 }}>FeatureStream tracks these features across every legal AI agent in the market — benchmarking where your product leads, where it lags, and what your roadmap needs to prioritise.</p>
