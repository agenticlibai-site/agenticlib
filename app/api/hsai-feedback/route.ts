...
export async function POST(req: Request) {
  try {
    ...
    console.log("[HSAI-FEEDBACK]", JSON.stringify({ ...data, _logged: new Date().toISOString() }, null, 2));
    ...
    await transporter.sendMail({
      ...
      subject: `HSAI Report Feedback — ${company}`,
      html: `
        <h2 style="font-family:sans-serif;color:#047857;margin:0 0 4px;">SimbaStack: Ranger AI Report Feedback</h2>
    ...
    console.error("[HSAI-FEEDBACK] email error:", err);
