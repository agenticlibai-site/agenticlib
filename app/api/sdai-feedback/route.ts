...
export async function POST(req: Request) {
  try {
    ...
    console.log("[SDAI-FEEDBACK]", JSON.stringify({ ...data, _logged: new Date().toISOString() }, null, 2));
    ...
    await transporter.sendMail({
      ...
      subject: `SDAI Report Feedback — ${company}`,
      html: `
        <h2 style="font-family:sans-serif;color:#7C3AED;margin:0 0 4px;">SDAI Report Feedback</h2>
    ...
    console.error("[SDAI-FEEDBACK] email error:", err);
