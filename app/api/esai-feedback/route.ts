...
export async function POST(req: Request) {
  try {
    ...
    console.log("[ESAI-FEEDBACK]", JSON.stringify({ ...data, _logged: new Date().toISOString() }, null, 2));
    ...
    await transporter.sendMail({
      ...
      subject: `EstiMate Report Feedback — ${company}`,
      html: `
        <h2 style="font-family:sans-serif;color:#EA580C;margin:0 0 4px;">Construction Estimating AI Report Feedback</h2>
    ...
    console.error("[ESAI-FEEDBACK] email error:", err);
