import {
  ...
  getSeamlessFeatureReport,
} from "@/lib/brand-visibility/db";
import SeamlessReportCharts from "./SeamlessReportCharts";

export const dynamic = "force-dynamic";

export const metadata = {
  title: "Seamless.ai — AI SDR & Outreach Visibility Report",
  description:
    "LLM visibility, share of voice, and feature score analysis for Seamless.ai in the AI SDR & Outreach category.",
};

export default async function SeamlessReportPage() {
  const [dailySummary, weeklySummary, llmVisibility, sovData, clusterPositions, featureReport] =
    await Promise.all([
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div style={{ marginBottom: 28 }}>
          <div
            ...
            style={{ background: "rgba(3,105,161,0.10)", color: "#0369A1" }}
          >
            Brand Intelligence · AI SDR &amp; Outreach
          </div>
          <h1
            className="text-3xl md:text-4xl font-bold mb-3"
            style={{ color: "#000000", letterSpacing: "-0.02em", lineHeight: 1.15 }}
          >
            Seamless.ai Visibility Report
          </h1>
          <p className="text-base" style={{ color: "#000000", lineHeight: 1.6, maxWidth: 560 }}>
            How AI models recommend and describe Seamless.ai across Claude and GPT-4o-mini,
            benchmarked against the AI SDR &amp; Outreach category.
          </p>
          <div style={{
            marginTop: 14,
            display: "inline-flex",
            ...
            <span><strong>Clari → Salesloft</strong> merged Dec 2025, tracked separately</span>
          </div>
        </div>

        <SeamlessReportCharts
        ...
        <div style={{ marginTop: 56 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 24 }}>
            <span style={{
              ...
              color: "#0369A1", background: "rgba(3,105,161,0.08)", borderRadius: 999, padding: "6px 16px",
            }}>
              Glossary
            </span>
