...
const radioOptStyle = (selected: boolean): React.CSSProperties => ({
  ...
  borderRadius: 8,
  cursor: "pointer",
  background: selected ? "rgba(4,120,87,0.06)" : "transparent",
  transition: "border-color 0.15s, background 0.15s",
});

// ── Component ─────────────────────────────────────────────────────────────────
export default function HsaiFeedbackPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSubmitting(true);
    try {
      const res = await fetch("/api/hsai-feedback", {
        method: "POST",
    ...
    >
      <div style={{ width: "100%", maxWidth: 580 }}>
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          >
            Your take on the SimbaStack: Ranger AI Report
          </h1>
          ...
          >
            ...
            >
              <svg width="26" height="26" viewBox="0 0 26 26" fill="none">
                <path d="M6 13l5 5 9-10" stroke="#047857" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
              ...
              <div style={qStyle}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  >
                    <label
                      htmlFor="q2b"
                      style={{ fontSize: 13, fontWeight: 600, color: GREEN, display: "block", marginBottom: 8 }}
                    >
                      What specifically?
                    </label>
                    <textarea
