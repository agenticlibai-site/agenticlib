...
export const metadata = {
  title: "Lamigo Report: Sales AI Agent Visibility – FeatureStream",
  description:
        ...
        <div style={{ marginTop: 56 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column" as const, gap: 0 }}>
            {[
              ...
              { term: "Share of Voice by Use Case", def: "Measures the percentage of brand mentions within a specific sales use case. Rather than showing overall popularity, it shows which brands dominate each individual category." },
              { term: "Feature Score", def: "A 0–100 score reflecting how well an AI model can confirm and describe a specific product capability for a given brand. Strong (90): clearly confirmed. Present (70): confirmed but less detailed. Partial (35): mixed signals. Weak (10): not confirmed." },
