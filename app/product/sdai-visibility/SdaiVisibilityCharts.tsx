              ...
              features: [
                {
                  ...
                  brands: [
                    { brand: "Descript",     score: 90, band: "high",   evidence: "Free + Creator $12/mo + Pro $24/mo; named tiers fully listed on public /pricing page." },
                    { brand: "Synthesia",    score: 90, band: "high",   evidence: "Basic $0 + Starter $29/mo; all tiers named and priced at /pricing." },
                    { brand: "HeyGen",       score: 90, band: "high",   evidence: "Free + Creator $29/mo + Pro $49/mo + Business $149/mo; complete public pricing grid." },
                    { brand: "D-ID",         score: 80, band: "high",   evidence: "Lite $9/mo + Advanced $299/mo; studio and API pricing pages publicly accessible." },
                    { brand: "DeepBrain",    score: 80, band: "high",   evidence: "Starter $30/mo + Pro $225/mo publicly listed on aistudios.com/pricing." },
                    { brand: "Renderforest", score: 80, band: "high",   evidence: "Free tier + plans from $9.99/mo; /subscription page lists all tiers." },
                    { brand: "Opus Clip",    score: 70, band: "medium", evidence: "Free + Pro documented but monthly price unclear; Business tier is contact-only." },
                  ],
                },
                {
                  id: "security",
                  ...
                  brands: [
                    { brand: "Synthesia",    score: 100, band: "high",   evidence: "SOC 2 Type II + ISO 27001:2022 + ISO 42001; dedicated Trust Centre at security.synthesia.io; SSO." },
                    { brand: "Descript",     score:  90, band: "high",   evidence: "SOC 2 Type II, GDPR, CCPA, AES-256 encryption; public /security page." },
                    { brand: "HeyGen",       score:  90, band: "high",   evidence: "SOC 2 Type II, GDPR, EU AI Act compliance; SAML SSO, SCIM, RBAC, audit logs, DPO." },
                    { brand: "D-ID",         score:  70, band: "medium", evidence: "SOC 2 certified per blog post; GDPR implied; no public trust centre." },
                    { brand: "Opus Clip",    score:  50, band: "low",    evidence: "trust.opus.pro security portal; policies documented; no confirmed SOC 2." },
                    { brand: "Renderforest", score:  40, band: "low",    evidence: "GDPR compliance only; no SOC 2 or ISO certifications; consumer-focused posture." },
                    { brand: "DeepBrain",    score:  30, band: "weak",   evidence: "No verifiable public security certifications found at time of research." },
                  ],
                },
                {
                  id: "integrations",
                  ...
                  brands: [
                    { brand: "Descript",     score: 90, band: "high",   evidence: "API in open beta; /integrations page; Google Drive, Slack, Adobe Premiere, FCP, Dropbox, Zapier, Claude MCP connector." },
                    { brand: "Synthesia",    score: 90, band: "high",   evidence: "Full API at docs.synthesia.io; PowerPoint, 360Learning, HubSpot, Shopify, WordPress, LMS connectors." },
                    { brand: "HeyGen",       score: 80, band: "high",   evidence: "Zapier (Pro+, 9,000+ apps), native API + API pricing page, Video Agent API." },
                    { brand: "Opus Clip",    score: 80, band: "high",   evidence: "API (Business only); Zapier + Make.com native; Adobe Premiere + DaVinci Resolve export; social auto-post." },
                    { brand: "D-ID",         score: 80, band: "high",   evidence: "API-first product; d-id.com/pricing/api; PowerPoint plugin; Creative Reality Studio API." },
                    { brand: "DeepBrain",    score: 60, band: "medium", evidence: "API at docs.aistudios.com with webhooks; limited named third-party integrations." },
                    { brand: "Renderforest", score: 50, band: "low",    evidence: "API for subscribers; Google Analytics, Meta Pixel, SEMRush; backend SDKs only, no LMS/CRM." },
                  ],
                },
              ],
            },
