        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
          <div style={{ display: "flex", gap: 20, padding: "8px 0" }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ display: "flex", alignItems: "baseline", gap: 10, marginBottom: 8, flexWrap: "wrap" as const }}>
                <p style={{ fontSize: 15, fontWeight: 700, color: NAVY, margin: 0, letterSpacing: "-0.01em" }}>
                  <span style={{ color: PURPLE }}>Use Case 1: </span>Distribution
                </p>
                <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.06em", textTransform: "uppercase" as const, color: "#059669", background: "rgba(5,150,105,0.08)", border: "1px solid rgba(5,150,105,0.2)", borderRadius: 4, padding: "1px 7px", whiteSpace: "nowrap" as const, flexShrink: 0 }}>Highest priority</span>
              </div>
              <p style={{ fontSize: 14, color: "#000", margin: 0, lineHeight: 1.65 }}>
                {"Superdegree's entire value prop is customer education — \"products that educate with videos convert 10x better.\" But once a video is exported, Superdegree loses the customer. There is no hosted player, no embed code, no viewer analytics. The report data confirms this: Distribution is the weakest cluster across the whole competitive set, with only Synthesia scoring well. That is not a red flag — it is white space. A CS team making onboarding videos needs to know who watched, how far they got, and which steps they replayed. That completion signal is also the proof point for Superdegree's own conversion claim — right now they can assert it but cannot show it. A hosted player with per-video completion tracking would close that loop and make Superdegree the only platform in the set that both produces the video and tells you whether it worked."}
              </p>
            </div>
          </div>
        </div>
