              ...
              features: [
                {
                  ...
                  brands: [
                    { brand: "Descript",     score: 90, band: "high",   evidence: "Free, Creator ($12/mo), Pro ($24/mo), Business ($50/mo), and Enterprise tiers are all named and feature-compared on a public /pricing page with no sign-in required. Scores 90 rather than 100 because Business and Enterprise tiers are listed but custom-priced — the upper path still requires a sales conversation. Agent relevance: when a buyer asks an AI model what Descript costs, the model can return a specific figure because the page is indexable. Self-serve buyers — including teams evaluating Descript for automated content workflows — can qualify themselves entirely without friction." },
                    { brand: "Synthesia",    score: 90, band: "high",   evidence: "Basic (free), Starter ($29/mo), Creator ($89/mo), and Enterprise tiers are publicly listed with per-feature comparisons. Scores 90 because standard tiers are fully transparent but Enterprise requires a sales conversation. Agent relevance: the L&D teams most likely to adopt Synthesia for automated training video pipelines can assess fit, run a trial, and escalate to enterprise — all without a gated first step. LLMs can also answer Synthesia pricing questions with a specific number rather than a redirect." },
                    { brand: "HeyGen",       score: 90, band: "high",   evidence: "Four tiers — Free, Creator ($29/mo), Pro ($49/mo+), and Business ($149/mo+) — are fully priced and feature-compared on a public grid with no login required. Scores 90 because Business tier pricing is listed but the final terms require contacting sales. Agent relevance: HeyGen covers the widest public pricing range of any platform in this set, meaning LLMs can answer questions about fit across individual creator, SMB, and mid-market buyer segments with specific figures." },
                    { brand: "D-ID",         score: 80, band: "high",   evidence: "Studio plans (Lite $9/mo, Advanced $299/mo) and API plans are documented on separate public pricing pages. Scores 80 rather than 90 because the $290 gap between Lite and Advanced leaves a large mid-market blind spot, and enterprise API terms require a conversation. Agent relevance: the public API pricing page is particularly important — teams building avatar video into automated workflows can evaluate D-ID's programmatic cost without ever talking to sales, which is the path most AI agent buyers actually take." },
                    { brand: "DeepBrain",    score: 80, band: "high",   evidence: "Starter ($30/mo) and Pro ($225/mo) are listed with feature breakdowns on aistudios.com/pricing. Scores 80 because the tier gap is large, custom enterprise pricing is not disclosed, and the page is less comprehensive than the top-scoring platforms. Agent relevance: basic self-serve evaluation is supported — a buyer can arrive, read, and try without a gated step — but the sparse middle tier means teams with moderate budgets have limited guidance on where they fit." },
                    { brand: "Renderforest", score: 80, band: "high",   evidence: "A free tier and plans from $9.99/mo are listed on the /subscription page with clear feature breakdowns. Scores 80 because the page is transparent and self-serve, though the pricing structure reflects a broad template and design tool rather than a purpose-built AI video agent platform. Agent relevance: pricing is accessible and LLMs can answer cost questions accurately, but the positioning as a consumer/SMB product means enterprise AI agent buyers may find the tier structure misaligned with their procurement process." },
                    { brand: "Opus Clip",    score: 70, band: "medium", evidence: "Free and Pro tiers are documented, but the exact monthly price for Pro is not consistently visible without creating an account — the full pricing picture is gated behind sign-up. Business pricing is contact-only. Scores 70 because partial transparency exists but the self-serve evaluation path has friction at the most critical decision point. Agent relevance: when a buyer or an LLM is asked about Opus Clip's cost, the answer is likely incomplete or out of date — the missing price is precisely the figure that determines whether a team explores further or moves on." },
                  ],
                },
                {
                  id: "security",
                  ...
                  brands: [
                    { brand: "Synthesia",    score: 100, band: "high",   evidence: "Holds SOC 2 Type II, ISO 27001:2022, and ISO 42001 — the only platform in this set with an AI-specific management system certification. A dedicated Trust Centre at security.synthesia.io documents SSO, data residency options, and audit controls in a format built for procurement teams. Scores 100 because it is the only brand that satisfies all three layers: cross-jurisdictional data compliance, enterprise IAM controls, and AI-specific governance. Agent relevance: for AI agent deployments in regulated industries (financial services, healthcare, government), Synthesia is the only platform in this competitive set likely to pass a formal vendor security review without additional negotiation." },
                    { brand: "Descript",     score:  90, band: "high",   evidence: "SOC 2 Type II, GDPR, and CCPA compliance are documented on a public /security page alongside AES-256 encryption at rest. Scores 90 rather than 100 because there is no dedicated trust centre, SSO and SCIM provisioning are not prominently documented, and no AI-specific certification (ISO 42001) exists. Agent relevance: Descript's posture covers the security threshold for most creative, marketing, and enablement teams. For regulated industries or large enterprise IT procurement, the absence of a trust centre and SCIM documentation creates a gap that requires direct vendor engagement to resolve." },
                    { brand: "HeyGen",       score:  90, band: "high",   evidence: "SOC 2 Type II, GDPR, and EU AI Act compliance are all confirmed. SAML SSO, SCIM provisioning, RBAC, and audit logs are documented — and HeyGen employs a named Data Protection Officer, which is uncommon at this price point and signals genuine organisational investment in compliance rather than checkbox certification. Scores 90 rather than 100 because compliance documentation is spread across multiple pages rather than consolidated in a single trust centre. Agent relevance: particularly strong for European enterprise buyers, where EU AI Act alignment and a named DPO reduce the internal compliance escalation risk." },
                    { brand: "D-ID",         score:  70, band: "medium", evidence: "SOC 2 certification is referenced in company blog posts and announcements rather than a dedicated security or compliance page. GDPR compliance is implied through EU data handling practices but not formally documented in a buyer-accessible format. Scores 70 because the certification is real but the evidence surface is thin — a procurement team must search for it rather than finding it in a structured trust centre. Agent relevance: for enterprise teams conducting formal vendor security reviews, the lack of a dedicated page means D-ID requires direct vendor engagement to satisfy IT requirements, adding friction and delay to the procurement cycle." },
                    { brand: "Opus Clip",    score:  50, band: "low",    evidence: "A trust portal at trust.opus.pro documents security policies and infrastructure practices, but SOC 2 Type II certification has not been publicly confirmed at time of research. Scores 50 because the compliance infrastructure exists (policies, portal) but the flagship enterprise certification is absent or unconfirmed. Agent relevance: for teams using Opus Clip for internal content workflows in low-regulated environments, this is likely acceptable. For regulated industries or any team with a formal vendor security checklist, this will require a direct conversation with Opus Clip to obtain attestation letters — which adds friction and disqualifies the platform at the procurement gate." },
                    { brand: "Renderforest", score:  40, band: "low",    evidence: "GDPR compliance is documented as required for EU users, but no SOC 2, ISO 27001, or equivalent enterprise security certifications exist at time of research. Scores 40 because the bare legal minimum is met but enterprise procurement requirements are not addressed. Agent relevance: Renderforest is built for creators and small businesses, which is reflected in its security posture. For enterprise teams evaluating AI video tools for scale deployment — especially in industries with vendor security requirements — Renderforest will not clear the first procurement gate, limiting its relevance as an AI agent platform component." },
                    { brand: "DeepBrain",    score:  30, band: "weak",   evidence: "No verifiable public security certifications, trust centre, compliance documentation, or dedicated security page was found at time of research. Scores 30 rather than 0 because basic operational security is presumed for any production SaaS platform, but nothing is publicly verifiable. Agent relevance: this is the largest inhibitor to DeepBrain's enterprise adoption relative to its feature set. Any enterprise team conducting a formal vendor security assessment would need to engage DeepBrain directly to obtain any evidence of compliance — and the absence of public documentation signals this is not a current organisational priority. DeepBrain is effectively excluded from regulated enterprise shortlists in its current state." },
                  ],
                },
                {
                  id: "integrations",
                  ...
                  brands: [
                    { brand: "Descript",     score: 90, band: "high",   evidence: "API is in open beta with public documentation, plus a /integrations page naming Google Drive, Slack, Adobe Premiere, Final Cut Pro, Dropbox, Ecamm, and Zoom individually. A Claude MCP connector makes Descript invocable from AI agent workflows — not just usable as a standalone product. Scores 90 rather than 100 because the API is still in beta (no production SLA) and enterprise API contract terms are not yet publicly documented. Agent relevance: the Claude MCP connector is the most distinctive element in this set — it means Descript can be called as a tool by an orchestrating AI agent, positioning it uniquely for teams building multi-step AI content pipelines." },
                    { brand: "Synthesia",    score: 90, band: "high",   evidence: "A mature, production-ready REST API at docs.synthesia.io has been available long enough to develop a documented integration ecosystem. Named connectors cover PowerPoint, 360Learning, HubSpot, Shopify, WordPress, and major LMS platforms — meaning both the L&D buyer and the marketing automation buyer are explicitly served. Scores 90 rather than 100 because first-party API SLAs and enterprise support tiers are not prominently published. Agent relevance: Synthesia's LMS integrations are the most relevant for enterprise AI agent deployments — teams building automated training video pipelines can connect Synthesia directly to their existing learning infrastructure without custom engineering." },
                    { brand: "HeyGen",       score: 80, band: "high",   evidence: "Zapier integration (Pro+ plans) unlocks 9,000+ app connections without custom development. A native REST API and a dedicated Video Agent API are both available with separate API pricing documented. Scores 80 rather than 90 because Zapier access is plan-gated, the first-party named connector list is shorter than Descript or Synthesia, and API documentation depth is not at the same level. Agent relevance: the Video Agent API is the most relevant element — it enables programmatic avatar video generation at scale without a human in the loop, making HeyGen a candidate for automated demo, training, and communication video pipelines." },
                    { brand: "Opus Clip",    score: 80, band: "high",   evidence: "Business plan holders get API access. Native Zapier and Make.com integrations cover workflow automation without custom development, and Adobe Premiere and DaVinci Resolve exports serve professional post-production workflows. Social auto-posting to major platforms is built in. Scores 80 because API access is gated to Business tier, limiting availability for lower-tier teams. Agent relevance: the social auto-posting integration completes the full distribution step without additional tooling — making Opus Clip the most self-contained platform for automated clip-based social publishing, which is the specific workflow most relevant to its user base." },
                    { brand: "D-ID",         score: 80, band: "high",   evidence: "D-ID is built API-first — the Creative Reality Studio API is the primary product interface rather than an afterthought, with dedicated API pricing at d-id.com/pricing/api and comprehensive developer documentation. A PowerPoint plugin covers non-developer buyers. Scores 80 rather than 90 because named third-party connectors are limited, and Zapier or Make.com integrations are not documented. Agent relevance: the API-first architecture is the most relevant characteristic for AI agent builders — D-ID was designed for programmatic access, meaning it integrates more cleanly as a component in a multi-step AI workflow than platforms where the API was added after the manual product." },
                    { brand: "DeepBrain",    score: 60, band: "medium", evidence: "An API is documented at docs.aistudios.com with webhook support for event-driven workflows. Scores 60 because the API foundation exists but named third-party connectors are limited — teams integrating DeepBrain must build custom connections rather than using pre-built ones, which increases integration cost and time. Agent relevance: webhook support means basic event-driven automation is achievable, but the thin connector ecosystem means DeepBrain is harder to wire into enterprise tool stacks than Descript or Synthesia. Teams building AI video pipelines with DeepBrain face more custom development than the market leaders." },
                    { brand: "Renderforest", score: 50, band: "low",    evidence: "A subscriber API supports programmatic video creation, with analytics integrations for Google Analytics, Meta Pixel, and SEMRush documented. Scores 50 because the integration surface is analytics-only and backend SDKs — no native connectors exist for LMS, CRM, project management, or enterprise collaboration tools. Agent relevance: for AI agent buyers evaluating Renderforest as a programmatic video creation layer, the API is functional but the absence of ecosystem connectors means significant custom integration work. The analytics-focused integration set reflects Renderforest's positioning as a marketing creation tool rather than an enterprise workflow component — which limits its relevance as a node in an AI agent pipeline." },
                  ],
                },
              ],
            },
