...
import { Geist, Geist_Mono, Inter, Schibsted_Grotesk, Space_Mono, EB_Garamond } from "next/font/google";
import "./globals.css";
...
export const metadata: Metadata = {
  ...
  title: {
    default: "FeatureStream — The Product Management OS for AI Agent Builders",
  ...
  openGraph: {
    ...
    title: "FeatureStream — The Product Management OS for AI Agent Builders",
    description:
      "Benchmark your AI agent's visibility against competitors and turn feature gaps into a roadmap — so you show up where buyers are actually asking.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "FeatureStream — The Product Management OS for AI Agent Builders",
      },
    ],
  },
  twitter: {
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${geistSans.variable} ${geistMono.variable} ${inter.variable} ${schibstedGrotesk.variable} ${spaceMono.variable} ${ebGaramond.variable} h-full antialiased`}
    >
