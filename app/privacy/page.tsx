    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-14 space-y-8 text-black leading-relaxed">
        ...
        <section className="space-y-3">
          ...
          <h3 className="font-semibold text-black">a. Personal Information</h3>
          ...
          <h3 className="font-semibold text-black">b. Non-Personal Information</h3>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-black">3. Cookies and Tracking Technologies</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-black">4. Data Sharing and Disclosure</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-black">5. Data Retention</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-black">7. Your Rights</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-black">8. Third-Party Links</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-black">9. Changes to This Policy</h2>
          <p>
