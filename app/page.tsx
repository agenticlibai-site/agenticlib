            ...
            <div className="why-visual" style={{ position: "relative", height: 360, display: "flex", alignItems: "center", gap: 0, width: "100%", minWidth: 0 }}>
              ...
              <div style={{ flex: "none", display: "flex", flexDirection: "column", justifyContent: "space-between", height: 340, width: 190, zIndex: 3 }}>
                {[
                  ...
                  { label: "Use case intelligence", icon: <svg width="23" height="23" viewBox="0 0 24 24" fill="none" stroke="url(#hp-ic3)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><defs><linearGradient id="hp-ic3" x1="0" y1="1" x2="1" y2="0"><stop offset="0" stopColor="#7C3AED"/><stop offset="1" stopColor="#9B5DE5"/></linearGradient></defs><path d="M3.5 18.5 A8.5 8.5 0 0 1 20.5 18.5"/><path d="M12 18.5 L16.5 12.5"/><circle cx="12" cy="18.5" r="1.7" fill="url(#hp-ic3)" stroke="none"/></svg> },
                ].map(({ label, icon }) => (
