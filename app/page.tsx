    ...
    Contact Us
      ...
      <main className="relative z-0">
        ...
        <section style={{ background: "transparent", padding: "36px 24px 8px", fontFamily: "var(--font-schibsted), system-ui, sans-serif" }}>
          <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", overflow: "hidden", borderRadius: 32, background: "linear-gradient(150deg,#FDEAE4 0%,#FBD7CE 55%,#F6C6BC 100%)", boxShadow: "0 30px 70px rgba(90,26,50,.22)" }}>
