...
export default function Home() {
  ...
  return (
    <div className="page-bg relative text-black font-sans">
      ...
      {/* ── Why AgenticLib ────────────────────────────────────────────────────── */}
      <section style={{ position: "relative", overflow: "hidden", background: "linear-gradient(150deg,#EEE8FD 0%,#E8E5FD 55%,#F0E9FD 100%)", padding: "12px 24px 16px", fontFamily: "var(--font-schibsted), system-ui, sans-serif" }}>
      ...
      {/* ── Customised Reports ────────────────────────────────────────────────── */}
      <section className="cr-section" style={{ fontFamily: "var(--font-schibsted), system-ui, sans-serif", padding: "0 24px 0", marginTop: -52 }}>
