  ...
  <div className="max-w-4xl mx-auto text-center">
    ...
    >
      <img
        ...
        className="w-full h-24 object-cover object-[center_30%] rounded-xl shadow-md cursor-pointer hover:opacity-90 hover:-translate-y-0.5 transition"
      />
    </a>
...
<footer style={{ background: 'rgba(224, 214, 255, 0.55)', backdropFilter: 'blur(12px)', borderTop: '1px solid rgba(167,139,250,0.2)' }}>
  <div className="max-w-6xl mx-auto px-8 pt-8 pb-4 flex items-center justify-between">
    <span className="text-sm font-medium text-violet-900">&copy; 2026 AgenticLib</span>
    <img src="/logo.png" alt="AgenticLib" className="h-7 w-auto" style={{ mixBlendMode: 'multiply' }} />
  </div>
  <div className="max-w-6xl mx-auto px-8">
    <div style={{ borderTop: '1px solid rgba(0,0,0,0.12)' }} />
  </div>
  <div className="max-w-6xl mx-auto px-8 py-5 flex flex-wrap gap-x-7 gap-y-2">
    <Link href="/privacy" className="text-sm text-violet-700 hover:text-violet-900 transition">Privacy Policy</Link>
    <Link href="/terms" className="text-sm text-violet-700 hover:text-violet-900 transition">Terms &amp; Conditions</Link>
  </div>
</footer>
